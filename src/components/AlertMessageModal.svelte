...
<dialog
    ...
    class={twMerge(
        "raw-modal backdrop:bg-pf-black/90 m-auto w-[90%] md:w-full max-w-200 rounded-lg bg-white p-0 backdrop:backdrop-blur-[15px] overflow-hidden min-h-100",
        className,
    )}
>
    <button
    ...
    <div class="px-4 pt-20 pb-15 md:px-8">
       <AlertMessage type={type} message={message} title={title} messageClass="max-w-[456px]" />
       <slot name="actions" />
    </div>
</dialog>
